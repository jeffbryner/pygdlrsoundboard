...
Screen = (640,480)
pygame.display.set_caption('David Lee Roth soundboard--kinected!')
...
def play(filename):    
    ...
    device = alsaaudio.PCM(card='default', mode=alsaaudio.PCM_PLAYBACK)
    ...
    device.setperiodsize(256)
    data = f.readframes(256)
...
#       (0,0,0)x
    ...
    Blocks.append(Block(-.25, 0,   .70,"yeziam",'wavs/yeziam.wav',2.25)) #bottom, closest to kinect
    Blocks.append(Block(-.25, .30, .70,"illtellya",'wavs/illtellyaallaboutit.wav',2.25))  #top row, closest to kinect
    Blocks.append(Block(-.25, 0,   1.0,"nazgul",'wavs/nazgul.wav',2.25)) #bottom, 2nd row.
    Blocks.append(Block(-.25, .30, 1.0,"whoooooo",'wavs/whoooooo.wav',2.25)) #top, 2nd row.
    Blocks.append(Block(-.25, 0,   1.3,"mumble",'wavs/mumbleahhhyeah.wav',2.25)) #bottom, 3rd row.
    Blocks.append(Block(-.25, .30, 1.3,"oohimrunning",'wavs/oohimrunning.wav',2.25)) #top, 3rd row.
